...
import java.util.List;
 ...
 public class Vision {
    ...
    private Matrix<N3, N1> curStdDevs;
      ...
      */
     public Vision(EstimateConsumer estConsumer, String cameraName, Transform3d cameraPosition) {
         this.estConsumer = estConsumer;
         camera = new PhotonCamera(cameraName);
 
         photonEstimator =
                 new PhotonPoseEstimator(aprilTagFieldLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, cameraPosition);
