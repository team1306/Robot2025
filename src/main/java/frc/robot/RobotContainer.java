...
public class RobotContainer {
     ...
     */
    private final SwerveInputStream driveAngularVelocity = SwerveInputStream.of(drivebase
            .getSwerveDrive(), () -> -controller1.getLeftY(), () -> -controller1.getLeftX())
...
//       elevator.setDefaultCommand(new ElevatorFromSmartDashboard(elevator));
    ...
    public void bindOneController() {
        ...
        controller1.pov(0, 270, oneControllerEventLoop).onTrue(new InstantCommand(() -> selectedLevel = 1));
        controller1.pov(0, 180, oneControllerEventLoop).onTrue(new InstantCommand(() -> selectedLevel = 2));
        controller1.pov(0, 90, oneControllerEventLoop).onTrue(new InstantCommand(() -> selectedLevel = 3));
        controller1.pov(0, 0, oneControllerEventLoop).onTrue(new InstantCommand(() -> selectedLevel = 4));

        controller1.leftStick(oneControllerEventLoop).onTrue(new InstantCommand(() -> selectedLevel = 6));
        ...
        controller1.rightBumper(oneControllerEventLoop).onTrue(placeWrapper);
    ...
    public void bindAutomatic() {
        ...
        controller1.leftTrigger(0.5, fullAutomaticEventLoop)
                .onTrue(drivebase.changeSwerveSpeed(0.2))
    ...
    public void bindCommonControls(EventLoop loop) {
        ...
        new Trigger(loop, DriverStation::isAutonomousEnabled).whileTrue(new CustomWaitCommand(() -> autoWaitTime)
        ...
        Dashboard.getNetworkTablesButton("Speed Down", loop)
                .onTrue(drivebase.changeSwerveSpeed(0.1))
