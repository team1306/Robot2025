...
public class PlaceCoralL1 extends ParallelCommandGroup {
    
    public PlaceCoralL1(Elevator elevator, Arm arm, Wrist wrist) {
        ...
        addCommands(
            ...
            new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                    ...
                    new MoveWristToSetpoint(wrist, WristSetpoint.HORAZONTAL)
                )
            )
        );
