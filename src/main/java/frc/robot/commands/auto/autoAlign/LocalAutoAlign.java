...
public class LocalAutoAlign extends Command {
    ...
    public LocalAutoAlign(boolean isRight, SwerveSubsystem drivebase) {
    ...
    public void initialize() {
        ...
        yController.setSetpoint(isRight ? Constants.Y_SETPOINT : -Constants.Y_SETPOINT);
